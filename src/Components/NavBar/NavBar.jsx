  ...
  return (
    <>
      <header className="fixed top-0 w-full z-30">
        ...
        <nav
          aria-label="Global"
          className=" flex w-full items-center relative justify-between lg:justify-around p-3  px-4 sm:px-7 md:px-5"
        >
          {/* Logo on the Left */}
          ...
          <div className="flex  items-center">
            <a onClick={handleLogoClick}>
              <img
                ...
                src={logo}
                decoding="async"
                className="h-[50px] w-[60px] sm:h-[60px] sm:w-[70px]"
              />
            </a>
          </div>
          {/* on Mobile */}
                ...
                <>
                  ...
                  {open && (
                    ...
                    >
                      ...
                      <div className="w-full divide-gray-900/5 bg-gray-50 group">
                        {calls.map((item) => (
                          <a
                            key={item.name}
                            href={item.href}
                          ...
                          >
                            <item.icon
                              aria-hidden="true"
                              className="size-5 flex-none text-gray-400 group-hover:text-green-600 group-hover:scale-125 duration-200"
                            />
                            {item.name}
                          </a>
                        ))}
                      ...
                      <>
                        ...
                        {open && (
                          <DisclosurePanel className="my-2 bg-white space-y-2 rounded">
                            ...
                            <div className=" divide-x divide-gray-900/5 bg-gray-50 rounded group">
                              {calls.map((item) => (
                                <a
                                  key={item.name}
                                  href={item.href}
                                ...
                                >
                                  <item.icon
                                    aria-hidden="true"
                                    className="size-5 flex-none group-hover:text-green-600 group-hover:scale-125 duration-200"
                                  />
                                  {item.name}
                                </a>
                              ))}
